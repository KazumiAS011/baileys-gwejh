...
export type AIRichUnifiedResponseInput = proto.IAIRichResponseUnifiedResponse | Uint8Array | Buffer | string | Record<string, any>;
export type AIRichResponseMessageContent = {
    richResponse: {
        submessages: proto.IAIRichResponseSubMessage[];
        unifiedResponse?: AIRichUnifiedResponseInput;
        unifiedResponseData?: Uint8Array | Buffer | string | Record<string, any>;
        sources?: proto.BotSourcesMetadata.IBotSourceItem[];
        botJid?: string;
        text?: string;
        messageType?: proto.AIRichResponseMessageType | number;
        forwardOrigin?: number;
        forwardingScore?: number;
        isForwarded?: boolean;
        contextInfo?: proto.IContextInfo;
        botMetadata?: proto.IBotMetadata;
        deviceListMetadata?: proto.IDeviceListMetadata;
        deviceListMetadataVersion?: number;
    };
} | {
    richResponseMessage: proto.IAIRichResponseMessage;
    messageContextInfo?: proto.IMessageContextInfo;
} | {
    botForwardedMessage: proto.Message.IFutureProofMessage;
    messageContextInfo?: proto.IMessageContextInfo;
};
export type LegacyButtonListInteractiveContent = {
    buttons?: any[];
    templateButtons?: any[];
    sections?: any[];
    buttonText?: string;
...
} & Mentionable & Contextable & Editable) | (AIRichResponseMessageContent & Contextable) | (LegacyButtonListInteractiveContent & Partial<Mentionable> & Contextable & Editable) | AnyMediaMessageContent | {
...
export type MiscMessageGenerationOptions = MinimalRelayOptions & {
    ...
    /** if it is broadcast */
    broadcast?: boolean;
    /** add WhatsApp biz bot node only for private chats (@s.whatsapp.net / @lid); ignored for groups, status, newsletters and broadcasts */
    bizBot?: boolean;
};
